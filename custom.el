(custom-set-variables
 ...
 '(package-selected-packages
   '(fanyi popper resize-window buffer-move es-windows window-numbering treesit-auto highlight-global quelpa-use-package quelpa symbol-overlay expand-region evil-multiedit iedit general evil-anzu undo-tree org-contrib org airline-themes gruvbox-theme doom-modeline magit wgrep embark-consult consult cosult embark marginalia orderless vertico keycast company))
